...
class EscapePod(Scene):
    def enter(self):
        ...
        print(f"Hint: You should probably pick # {good_pod}.")
        guess = input("[pod #] > ")
...
a_map = Map('central_corridor') #set a_map to an instance of class Map()
a_game = Engine(a_map) #set a_game to an instance of class Engine with param self and (a_map)
